...
class FileTimeExtensionsTest
{
	...
	{
		LocalDateTime creationTime = FileTimeExtensions.getTimestamp(testFile, FileTimestampType.CREATION);
	...
	{
		LocalDateTime modifiedTime = FileTimeExtensions.getTimestamp(testFile, FileTimestampType.LAST_MODIFIED);
	...
	{
		LocalDateTime accessTime = FileTimeExtensions.getTimestamp(testFile, FileTimestampType.LAST_ACCESS);
	...
	void testGetTimestampWithPath() throws Exception
	{
		...
		LocalDateTime timestamp = FileTimeExtensions.getTimestamp(path, FileTimestampType.LAST_MODIFIED);
