...
public class ProcessTakeOutDirectoryTest
{
	 ...
	 * ## Process flow
	 *
	 * 1. create temp folder for the output from the downloaded files if not exists create one.
	 * 2. Download zip file from google drive
	 * 2. run unit test for process
	 * 3. in the unit test extract the zip file in the temp folder
	 * 4. Remove all duplicated files and google related configuration files
	 * 5. pack all files again in zip files
	 * 6. upload all zip files to google drive
	 *
	 * # course of action
	 */
	@Test(
